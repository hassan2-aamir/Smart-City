 ...
 * @author hp
 */
public class FoodSpots extends javax.swing.JFrame {
    ...
    public FoodSpots(String imagePath,String title, String description,String facilities,String cuisine,int rating,String timing) {
        ...
        initComponents();
        loadImage(imagePath,jLabel2);
        loadtext(description,jLabel11);
        loadtext(facilities,jLabel7);
        loadtext(cuisine,jLabel9);
        loadtext(String.valueOf(rating),jLabel13);
        loadtext(timing,jLabel10);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 280, -1, -1));
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 20, 240, 220));
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 310, 320, 110));

        jLabel8.setFont(new java.awt.Font("Microsoft JhengHei", 1, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Cuisine");
        ...
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 120, 340, 140));
        ...
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 260, 50, 30));

        jLabel6.setFont(new java.awt.Font("Dialog", 0, 36)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 51));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("⭐");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 260, 50, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FoodSpots.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
